#!/usr/bin/env python3
"""
Recupero codici sconto Kasanova da shopilo.it
Sursa: https://shopilo.it/negozi/kasanova.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/kasanova.it"
STORE_NAME = "Kasanova"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Kasanova da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-kasanova)"
    }
    try:
