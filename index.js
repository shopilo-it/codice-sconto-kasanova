 ...
 * Homepage: https://shopilo.it/negozi/kasanova.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/kasanova.it";
const STORE_NAME  = "Kasanova";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-kasanova)" }
  });
